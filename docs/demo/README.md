...
For traffic graph construction details, cross-map validation, and strategy
comparison figures for all six validation maps, see
[docs/traffic_graph.md](../traffic_graph.md).
